...
public class CreateSceneActivity extends BaseActivity implements View.OnClickListener,
    ...
    private TextView ed_edit_name, tv_scene_delete;
    ...
    protected void findViewById() {
        ...
        tv_scene_delete = findViewById(R.id.tv_scene_delete);
        ed_edit_name.setOnClickListener(this);
        tv_scene_delete.setOnClickListener(this);
